                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="/detail">Wawancara</a>
                                    </div>
                                </li>
            ...
            <div class="tm-page-content">                
                ...
                <section id="tm-section-1" class="row tm-section">
                    <div class="col-xs-12 text-center">
                        <img src="bootstrap/img/logo.png" alt="PKBM Golden Kids" style="width: 450px; display: block; margin: 0 auto;">
                        <p style="margin-top: 10px;" class="text-center">Homeschooling Golden Kids</p>
                        <!-- Tombol Daftar Sekarang -->
                        <button onclick="window.location.href = '/login';">Daftar Sekarang</button>
                ...
                <section id="tm-section-2" class="row tm-section">
                    <div class="tm-flex-center col-xs-12 col-sm-6 col-md-6 col-lg-5 col-xl-6">
                        <img src="bootstrap/img/strip-01.jpg" alt="Image" class="img-fluid tm-img">
                    </div>
                    ...
                    <div class="tm-white-curve-right col-xs-12 col-sm-6 col-md-6 col-lg-7 col-xl-6">
                        ...
                        <div class="tm-white-curve-text">
                            <h2 class="tm-section-header red-text">Sekolah Golden Kids</h2>
                ...
                <section id="tm-section-3" class="row tm-section">
                    <div class="tm-white-curve-left col-xs-12 col-sm-6 col-md-6 col-lg-7 col-xl-6">
                        ...
                        <div class="tm-white-curve-text">
                            <h2 class="tm-section-header gray-text">Sekolah Golden Kids</h2>
                            <p class="thin-font">PKBM Golden Kids adalah sekolah yang berdedikasi untuk memberikan pendidikan inklusif bagi anak-anak dengan kebutuhan khusus. Kami berkomitmen untuk menciptakan lingkungan belajar yang menyenangkan, aman, dan mendukung bagi setiap anak untuk tumbuh dan berkembang secara optimal.</p>
                        </div>
                ...
                <section id="tm-section-2" class="row tm-section">
                    ...
                    <div class="tm-white-curve-right col-xs-12 col-sm-6 col-md-6 col-lg-7 col-xl-6">
                        ...
                        <div class="tm-white-curve-text">
                            <h2 class="tm-section-header red-text">Visi Misi</h2>
                            <p>PKBM Golden Kids adalah sekolah yang berdedikasi untuk memberikan pendidikan inklusif bagi anak-anak dengan kebutuhan khusus. Kami berkomitmen untuk menciptakan lingkungan belajar yang menyenangkan, aman, dan mendukung bagi setiap anak untuk tumbuh dan berkembang secara optimal.</p>    
                        </div>
                ...
                <section id="tm-section-3" class="row tm-section">
                    <div class="tm-white-curve-left col-xs-12 col-sm-6 col-md-6 col-lg-7 col-xl-6">
                        ...
                        <div class="tm-white-curve-text">
                            <h2 class="tm-section-header gray-text">Fasilitas</h2>
                            <p class="thin-font">PKBM Golden Kids adalah sekolah yang berdedikasi untuk memberikan pendidikan inklusif bagi anak-anak dengan kebutuhan khusus. Kami berkomitmen untuk menciptakan lingkungan belajar yang menyenangkan, aman, dan mendukung bagi setiap anak untuk tumbuh dan berkembang secara optimal.</p>
                        </div>
                ...
                <section id="tm-section-3" class="row tm-section">
                    ...
                    <div class="images-row">
                        <img src="bootstrap/img/strip-02.jpg" alt="Gambar 1" class="img-fluid tm-img">
                        <p>bimbel</p>
                    </div>
                    <div class="images-row">
                        <img src="bootstrap/img/strip-02.jpg" alt="Gambar 2" class="img-fluid tm-img">
                        <p>bimbel</p>
                    </div>
                    <div class="images-row">
                        <img src="bootstrap/img/strip-02.jpg" alt="Gambar 3" class="img-fluid tm-img">
                        <p>bimbel</p>
                    </div>
                </section>
                ...
                <section id="tm-section-2" class="row tm-section">
                    ...
                    <div class="tm-white-curve-right col-xs-12 col-sm-6 col-md-6 col-lg-7 col-xl-6">
                        ...
                        <div class="tm-white-curve-text">
                            <h2 class="tm-section-header red-text">Metode Pembelajaran</h2>
                ...
                <section id="tm-section-3" class="row tm-section">
                    <div class="tm-white-curve-left col-xs-12 col-sm-6 col-md-6 col-lg-7 col-xl-6">
                        ...
                        <div class="tm-white-curve-text">
                            <h2 class="tm-section-header gray-text">Keunggulan</h2>
                            <p class="thin-font">Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum</p>
                        </div>
