...
-->
    ...
    <body>
        ...
        <div class="row navbar-row">
            ...
            <!-- Login Form -->
                <section id="tm-section-detail" class="row tm-section-detail">
                    <div class="form-group">
                        <h3>Detail Wawancara</h3>
                        <p>Nama: <span id="nama">John Doe</span></p>
                        <p>TTL: <span id="ttl">Jakarta, 1 Januari 2000</span></p>
                        <p>Jenjang: <span id="jenjang">SMA</span></p>
                        <p>Tanggal: <span id="jadwal_tanggal">1 Juni 2024</span></p>
                        <p>Waktu: <span id="jadwal_waktu">09:00 - 10:00 WIB</span></p>
                    </div>
                </section> <!-- #login -->
